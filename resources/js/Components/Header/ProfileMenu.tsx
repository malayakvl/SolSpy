        ...
        <Dropdown>
          ...
          <Dropdown.Content>
            ...
            <button
              ...
              className="w-full text-left px-4 py-2 text-sm leading-5 text-white hover:bg-[#703ea2] focus:outline-none focus:bg-[#703ea2] transition duration-150 ease-in-out"
            >
              {lng.get('menu.logout')}
            </button>
          </Dropdown.Content>
