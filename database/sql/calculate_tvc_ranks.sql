-- Function to calculate TVC ranks for all validators
-- TVC Rank is determined by sorting validators by TVC Score in descending order
-- Higher TVC Score = Lower (Better) Rank Number
